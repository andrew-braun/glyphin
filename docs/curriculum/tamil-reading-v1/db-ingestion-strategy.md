# Tamil Reading DB Ingestion Strategy

This file plans how reviewed authoring artifacts for `tamil-reading-v1` should
...
- Should Tamil pulli forms be stored as distinct graphemes, base-consonant
  variants, or rule-linked segment rows?
- How should dependent vowel signs be represented so `க`, `கா`, `கி`, and `கை`
...
- Does the delivery payload need a script-shaping metadata block for font family,
  cluster boundaries, and mark-placement hints?
