# Hindi Devanagari Reading DB Ingestion Strategy

This file plans how reviewed authoring artifacts for `hindi-devanagari-v1`
...
| Reviewed consonants vowels signs and conjuncts | `curriculum.graphemes`, `curriculum.course_version_graphemes`                                     |
| Akshara and matra segmentation                 | `curriculum.vocabulary_segments`, `curriculum.anchor_segments`                                    |
...
- Store learner-visible Hindi text in NFC and preserve original reviewed forms.
- Represent akshara parts in structured segment metadata rather than embedding
  parser-specific strings in lesson copy.
...
- [ ] Every new pedagogical unit maps to one script system and one
      course-version pedagogy row.
- [ ] Every anchor word has reviewed akshara segmentation.
...
- Which fields carry matra position and akshara segmentation in the runtime
  payload?
