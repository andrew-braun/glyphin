# Gujarati Reading DB Ingestion Strategy

This file plans how reviewed authoring artifacts for `gujarati-reading-v1`
...
| Reviewed Gujarati units and signs | `curriculum.graphemes`, `curriculum.course_version_graphemes`                                     |
...
- Store learner-visible Gujarati text in NFC and preserve original reviewed
  forms.
- Represent matra position, anusvara, virama clusters, and rare nukta in
...
- Which fields carry matra position, virama clusters, and rare nukta in the
  runtime payload?
