# Coptic Reading DB Ingestion Strategy

This file plans how reviewed authoring artifacts for `coptic-reading-v1` should move
...
- Should dialect scope live at the course version, lesson, word, or pronunciation
  hint level?
- Should supralinear marks become grapheme rows, orthography rules, edition
  metadata, or reviewer-only annotations?
- How should Coptic source editions and sacred-text context be carried into
  `delivery` payloads without overloading the current lesson model?
