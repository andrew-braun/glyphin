...
| app-authored-hebrew-domain-examples | authored_examples     | shipped_content | app_owned                                                    | Short menu, sign, and label examples authored by GlyphBridge from reviewed vocabulary rather than copied from third-party corpora. |
