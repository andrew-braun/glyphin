# English Braille Reading DB Ingestion Strategy

This file plans how reviewed authoring artifacts for `english-braille-v1` should move
...
- Should braille cells be stored as grapheme rows with dot-number JSON metadata
  or as a separate tactile notation table?
- How should source English text, braille cells, accessible labels, and future
  haptic patterns stay synchronized?
- Should UEB grade level and contraction status live at course version, lesson,
  word, or cell level?
