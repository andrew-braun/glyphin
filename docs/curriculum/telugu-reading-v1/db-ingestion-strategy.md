# Telugu Reading DB Ingestion Strategy

This file plans how reviewed authoring artifacts for `telugu-reading-v1` should
...
- Should Telugu virama and conjunct forms be stored as distinct graphemes,
  base-consonant variants, or rule-linked segment rows?
- How should dependent vowel signs be represented so `క`, `కా`, `కి`, and `కై`
