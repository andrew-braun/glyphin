...
| app-authored-telugu-domain-examples | authored_examples    | shipped_content | app_owned                                                    | Short menu, sign, and label examples authored by GlyphBridge after reviewer approval.                                            |
