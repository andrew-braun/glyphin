# Shavian Reading DB Ingestion Strategy

This file plans how reviewed authoring artifacts for `shavian-reading-v1` should
...
| Reviewed Shavian letters   | `curriculum.graphemes`, `curriculum.course_version_graphemes`                                     |
| Pronunciation policy       | `curriculum.course_versions.release_notes` or metadata pending convention                         |
...
- Store Shavian source text and approved English gloss separately from standard
...
- Activate the publication only after smoke checks confirm payload shape, font
  support, symbol accessibility, and transcription consistency.
...
- [ ] Every Shavian letter maps to one script system and one course-version
      pedagogy row.
...
- Should Shavian anchors store IPA, plain English pronunciation hints, or both?
...
- Should audio prompts be generated or recorded before release?
