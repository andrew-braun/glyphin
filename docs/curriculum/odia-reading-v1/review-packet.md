...
| app-authored-odia-domain-examples | authored_examples                     | shipped_content | app_owned                                                    | Short Odia menu, sign, and label examples authored by GlyphBridge after reviewer validation.                                     |
