# Deseret Reading DB Ingestion Strategy

This file plans how reviewed authoring artifacts for `deseret-reading-v1` should
...
| Reviewed Deseret letters      | `curriculum.graphemes`, `curriculum.course_version_graphemes`                                     |
| Pronunciation and case policy | `curriculum.course_versions.release_notes` or metadata pending convention                         |
...
- Store Deseret source text and approved English gloss separately from standard
  English spelling and pronunciation notes.
...
- Activate the publication only after smoke checks confirm payload shape, font
  support, symbol accessibility, case handling, and transcription consistency.
...
- [ ] Every Deseret letter maps to one script system and one course-version
      pedagogy row.
...
- Should Deseret anchors store IPA, plain English pronunciation hints, or both?
...
- Should case-pair matching be a generic app feature or Deseret-specific metadata?
