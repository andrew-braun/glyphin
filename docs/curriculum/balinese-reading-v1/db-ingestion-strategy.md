# Balinese Reading DB Ingestion Strategy

This file plans how reviewed authoring artifacts for `balinese-reading-v1`
...
- Store Balinese strings in NFC and retain audit copies for clusters with vowel
  signs, final signs, adeg-adeg, or stacked behavior.
...
- Should aksara-like units be stored as graphemes, vocabulary segments, or rule
  examples?
- Which font family is approved for production Balinese rendering?
