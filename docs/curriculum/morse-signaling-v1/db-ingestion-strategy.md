# Morse Signaling Reading DB Ingestion Strategy

This file plans how reviewed authoring artifacts for `morse-signaling-v1` should move
...
- Should Morse signal elements live in `curriculum.graphemes` with timing JSON or
  in a new signal-unit table?
- How should symbolic notation, audio playback, light pulses, and haptic pulses
  be generated from one reviewed source of truth?
- How should prosigns and gap-less command sequences map into delivery payloads
  without pretending they are ordinary words?
