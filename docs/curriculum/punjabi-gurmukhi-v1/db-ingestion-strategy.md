# Punjabi Gurmukhi Reading DB Ingestion Strategy

This file plans how reviewed authoring artifacts for `punjabi-gurmukhi-v1`
...
| Reviewed Gurmukhi units and marks | `curriculum.graphemes`, `curriculum.course_version_graphemes`                                     |
| Akshara and sign segmentation     | `curriculum.vocabulary_segments`, `curriculum.anchor_segments`                                    |
...
- Store learner-visible Punjabi text in NFC and preserve original reviewed
  Gurmukhi forms.
- Represent vowel bearers, matras, tippi, bindi, addak, nukta, and pairin forms
  in structured segment metadata.
...
- Which fields carry addak, tippi, bindi, nukta, and pairin roles in the runtime
  payload?
- Should nukta letters be stored as separate graphemes or base-plus-mark
  variants?
