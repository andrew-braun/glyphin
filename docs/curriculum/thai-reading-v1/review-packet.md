...
| --------------------------------- | -------------------- | --------------- | ------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------- |
| runtime-thai-course               | runtime_seed         | shipped_content | app_owned                                                    | Existing GlyphBridge Thai runtime lessons. Treat as the source of truth for this backfill packet.                                            |
...
| app-authored-thai-domain-examples | authored_examples    | shipped_content | app_owned                                                    | Short menu, sign, and label examples authored by GlyphBridge rather than copied from third-party corpora.                                    |
